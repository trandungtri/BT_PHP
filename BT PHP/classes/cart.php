	...
	class cart
	{
		...
		public function add_to_cart($id, $quantity)
		{
			...
			if($result['productQuantity']>$quantity){
				...
				$msg = "<span class='erorr'> Số lượng ".$quantity." bạn đặt quá số lượng chúng tôi chỉ còn ".$result['productQuantity']." cái</span> ";
				return $msg;
			}
		...
		public function update_quantity_Cart($proId,$cartId, $quantity)
		{
			...
			if($quantity<$result_product['productQuantity']){
				...
				$msg = "<span class='erorr'> Số lượng ".$quantity." bạn đặt quá số lượng chúng tôi chỉ còn ".$result_product['productQuantity']." cái</span> ";
				return $msg;
			}
		...
		public function shifted($id,$proid,$qty,$time,$price)
		{
			...
			if($get_select){
				while($result = $get_select->fetch_assoc()){
					$soluong_new = $result['productQuantity'] - $qty;
